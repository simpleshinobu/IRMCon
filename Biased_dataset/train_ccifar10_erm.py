...
parser.add_argument('--add_note', type=str, default="ccifar_erm")
...
for restart in range(args.n_restarts):
    ...
    dataset_train = our_dataset_cifar10(gen_dataset.envs[0], train_transform)
    dataset_train_eval = our_dataset_cifar10(gen_dataset.envs[0], test_transform)
